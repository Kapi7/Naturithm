"""Naturithm Agent Team — Oria's creative team powered by Claude."""
...
class NaturithmTeam:
    ...
    def __init__(self, api_key: str | None = None):
        ...
        self.director = Agent("Oria (Creative Director)", CREATIVE_DIRECTOR, self.client)
        self.content_creator = Agent("Content Creator", CONTENT_CREATOR, self.client)
        self.market_researcher = Agent("Market Researcher", MARKET_RESEARCHER, self.client)
        self.copywriter = Agent("Copywriter", COPYWRITER, self.client)
        self.social_manager = Agent("Social Media Manager", SOCIAL_MEDIA_MANAGER, self.client)
    ...
    def process_idea(self, idea: str) -> dict:
        ...
        # Step 1: Director breaks down the idea
...
Be specific. Each agent needs a clear, actionable brief."""
        ...
        # Step 2: Each agent processes their part
